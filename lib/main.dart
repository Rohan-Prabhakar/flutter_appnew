...
import 'package:flutter_appnew/utils.dart';
import 'package:flutter_appnew/widget/moods.dart';
      ...
      child: Column(
        children: <Widget>[
          ...
          Row(
            ...
            children: <Widget>[
              _iconBuilder(CupertinoIcons.check_mark_circled, 'Check-in'),
              _iconBuilder(CupertinoIcons.xmark_circle, 'Cancel'),
              _iconBuilder(CupertinoIcons.calendar, 'Calender'),
              _iconBuilder(CupertinoIcons.compass, 'Directions'),
            ],
          )
        ],
      ),
